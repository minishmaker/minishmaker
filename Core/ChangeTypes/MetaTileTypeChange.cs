...
{
    public class MetaTileTypeChange : AreaChangeBase
    {
        public MetaTileTypeChange(int areaId, int bgNum) : base(areaId, DataType.metaTileType, bgNum)
        {
        }
        ...
        public override string GetEAString(out byte[] binDat)
        {
            ...
            byte[] data = null;
            var size = area.GetCompressedMetaTileTypes(ref data, this.identifier);
        ...
        public override string GetJSONString()
        {
            ...
            if (identifier == 1)
            {
                return area.Bg1MetaTileset.SaveTypesToJSON();
            }
            return area.Bg2MetaTileset.SaveTypesToJSON();
        }
    }
}
