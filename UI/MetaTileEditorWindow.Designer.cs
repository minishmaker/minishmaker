namespace MinishMaker.UI
{
	partial class MetaTileEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.metaTileSetBox = new System.Windows.Forms.PictureBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.metaTileSetBox)).BeginInit();
			...
			this.metaTileSetPanel.Controls.Add(this.metaTileSetBox);
			...
			// metaTileSetBox
			// 
			this.metaTileSetBox.Location = new System.Drawing.Point(0, 0);
			this.metaTileSetBox.Name = "metaTileSetBox";
			this.metaTileSetBox.Size = new System.Drawing.Size(100, 50);
			this.metaTileSetBox.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize;
			this.metaTileSetBox.TabIndex = 0;
			this.metaTileSetBox.TabStop = false;
			this.metaTileSetBox.Click += new System.EventHandler(this.metaTileSetBox_Click);
			// 
			// tileSetPanel
			// 
			...
			this.tileSetBox.Size = new System.Drawing.Size(100, 50);
			...
			((System.ComponentModel.ISupportInitialize)(this.metaTileSetBox)).EndInit();
		...
		private System.Windows.Forms.PictureBox metaTileSetBox;
