...
using Room = MinishMaker.Core.Room;
...
namespace MinishMaker.Utilities
{
    public class MapManager
    {
        ...
        private bool IsValidRoom(int area, int room)
        {
            ...
            int searchaddr = ROM.Instance.headers.MapInfoRoot + (area << 2);
        ...
        private bool IsAddedRoom(int area, int room)
        {
            return false;
        }
        ...
        {
            int areasearchaddr = ROM.Instance.headers.ListTableRoot + (area << 2);
